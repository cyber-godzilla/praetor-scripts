...
Keep them true: update the metadata in the same change that alters a mode's arguments. Nothing validates arguments against `usage` — these fields only describe.
